jQuery.sap.declare("NavigationXMLView.Component");
 
sap.ui.core.UIComponent.extend("NavigationXMLView.Component", {
	...
	//busyDialog.open();
		...
		var oView = sap.ui.view({
			id : "app",
			viewName : "NavigationXMLView.navigationxmlview.App",
			type : "JS",
